...
test_that("{shinytest2} Testing changes to std_methods using demo_data", {
  ...
  app$set_inputs(`colSelect-DIGBACLSmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-WAISmethod` = "T-score (NA)", wait_ = F)
  app$set_inputs(
  ...
  app$set_inputs(`colSelect-MINTTOTSmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-ANIMALSmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-VEGmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-UDSVERTNmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-UDSVERFCmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-UDSVERLCmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(
    `colSelect-BOSTONmethod` = "regression (nacc_legacy)",
    wait_ = F
  )
  app$set_inputs(`colSelect-UDSBENTCmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-UDSBENTDmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-CRAFTVRSmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-CRAFTURSmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-CRAFTDVRmethod` = "regression (nacc)", wait_ = F)
  app$set_inputs(`colSelect-CRAFTDREmethod` = "regression (nacc)", wait_ = F)
  # app$set_inputs(`colSelect-REYDLISTmethod` = "T-score (NA)", wait_ = F)
  app$set_inputs(`colSelect-REY6RECmethod` = "T-score (NA)", wait_ = F)
  app$set_inputs(`colSelect-REYDRECmethod` = "T-score (NA)", wait_ = F)
  app$set_inputs(
  ...
  app$wait_for_idle(duration = 1000)
  # Update output value
  app$set_inputs(main_navbar = "colSelect")

  app$set_window_size(width = 1619, height = 968)

  # app$set_inputs(
  #   `colSelect-vars_table_output_cells_selected` = c(14, 6),
  #   allow_no_input_binding_ = TRUE
  # )
...
<option value=\"regression (updated)\">regression (updated)</option></select>
  ...
  app$click("colSelect-assign", wait_ = FALSE)
  ...
  app$set_inputs(
    # fmt: skip
    `General Cognition-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = FALSE
  )
  app$set_inputs(
  ...
  app$set_inputs(
    # fmt: skip
    `Attention/Processing-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = FALSE
  )
  app$set_inputs(
  ...
  app$set_inputs(
    # fmt: skip
    `Language-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = FALSE
  )
  app$set_inputs(
  ...
  app$set_inputs(
    # fmt: skip
    `Visuospatial-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = FALSE
  )
  app$set_inputs(
  ...
  app$set_inputs(
    # fmt: skip
    `Memory-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = FALSE
  )
  app$set_inputs(
  ...
  app$set_inputs(
    # fmt: skip
    `Executive Functioning-TraceMapping` = c("", 0, "", "", "dashed", 1, "", "", "Impaired", 2, "", TRUE, "dashed", 3, "", "", "Borderline", 4, "", TRUE, "dashed", 5, "", "", "Low Average", 6, "", TRUE, "dashed", 7, "", "", "Average", 8, "", TRUE, "dashed", 9, "", "", "High Average", 10, "", TRUE, "dashed", 11, "", "", "Superior", 12, "", TRUE, "dashed", 13, "", "", "Very Superior", 14, "", TRUE),
    allow_no_input_binding_ = TRUE,
    wait_ = F
  )
  app$set_inputs(
