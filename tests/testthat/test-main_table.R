test_that("assessment_summary_table", {
  ...
  # expect_true(
  #   all(
  #     assessment_table$Description %in% c(
  #       NA,
  #       "Average",
  #       NA,
  #       "Borderline",
  ...
  #   std = c(NA, NA, NA, 0.19807, 0.04167, 0.09524, 0.07692, 0.28571,
  ...
  #
  # expect_equal(
  #   assessment_table |> dplyr::mutate(dplyr::across(dplyr::where(is.numeric), \(x) round(x, digits = 5))),
  #   manual_test_table
  # )
})
